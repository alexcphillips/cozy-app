 ...
 * authoritative description of the schema - if you add a column, add it here
 * and to the matching `*.types.ts` row type in the module that owns the table.
 *
 * Deliberately not a migration runner: the app is small enough that additive
 * DDL is safe. Introduce real migrations before the first destructive change.
 */
